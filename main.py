...
BOT_TOKEN = "6037392010:AAGy48RCWILf_y-Sv_d3LCQ5AxBD50KGZDc"
PAYMENT_CHANNEL = "@Refer2Earrn" #add payment channel here including the '@' sign
OWNER_ID = 5452815871 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@Refer2Earrn"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
